...
a value of type (non-const) \tcode{X}, and \tcode{rv}
denotes an rvalue of type (non-const) \tcode{X}.
...
and \tcode{c} denotes a value of type \tcode{X::key_compare} or \tcode{const X::key_compare};
...
and \tcode{nh} denotes an rvalue of type \tcode{X::node_type}.
